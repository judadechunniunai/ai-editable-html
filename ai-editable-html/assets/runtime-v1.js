(function () {
  ...
  style.textContent = ".ai-editable-flow-rendered{background:#f8fafc;border:1px solid #d8dee8;border-radius:8px}.ai-flow-lines{position:absolute;inset:0;width:100%;height:100%;pointer-events:none}.ai-flow-lines line{stroke:#64748b;stroke-width:2}.ai-flow-edge-label{position:absolute;z-index:2;transform:translate(-50%,-50%);padding:4px 10px;border-radius:999px;background:#fff;color:#526070;font:600 12px/1.2 system-ui,-apple-system,Segoe UI,sans-serif;box-shadow:0 2px 8px rgba(15,23,42,.12)}.ai-flow-node{position:absolute;display:flex;align-items:center;justify-content:center;padding:8px 12px;box-sizing:border-box;border:1px solid #94a3b8;border-radius:8px;background:#fff;color:#172033;font:600 14px/1.2 system-ui,-apple-system,Segoe UI,sans-serif;box-shadow:0 6px 16px rgba(15,23,42,.08)}";
